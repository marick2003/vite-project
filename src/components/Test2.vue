<template>
    <div class="main">
            <select >
                <option v-for="(item,index) in clientType" :key="item" :value="index">{{item}}</option>
            </select>
        ...
        data() {
            return {
               ...
               numbers:{
                ...
                clientType:{
                    '1': 'Windows', '2': 'iOS', '3': 'Android', '4': 'Android TV', '5': 'Mac OS', '6': 'Apple TV'
                },
                notifications: [
                    {
                        id: 1,
